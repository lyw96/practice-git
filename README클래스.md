...
#42번째 줄 def init_list(self, 1): 에서 'self'와 '1' 두개가 있으니깐 46번째 줄에도  a.init_list(1, 2)에 '1'과 '2' 두개를 대입함     (self=1, 1=2) 그러면 43번째 줄 self.list = 1에서 에러가 생김(1.list = 2) 2개의 인자를 받아야하는데 3개의 인자를 받음.
